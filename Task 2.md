...
2. Write name of instance ,add the shh key and also save it if creating new, This is a simple tutorial so leave security group and networking settings as it for now.

![image.png](Images/Task%202/image%201.png)

3. Click on instace ID, In the lower menu select Security→ click on the security group ID

![image.png](Images/Task%202/image%202.png)

4. Click on edit inbound rules, set http as 0.0.0.0(anywhere) and ssh to your ip address(custom).
...
6. Now that inbound rules are changed. Move to instance id again and click Connect.
...
10. Now that it is up and running, type your ip in your browser → It will show welcome to nginx.

![image.png](Images/Task%202/image%209.png)

![image.png](Images/Task%202/image%2010.png)

11. Change the ssh to 0.0.0.0 for the ease of task. It all comes down to who has the access to we added to the instance on creation.

![image.png](Images/Task%202/image%2011.png)

12. Click on connect go to EC2 instance Connect and click on connect. You will see your instance up and running in AWS itself.
